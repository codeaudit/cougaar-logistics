 ...
 * @since 1/28/01
 **/
public class RoutesDataFactory implements DeXMLableFactory{
  ...
  public DeXMLable beginSubObject(DeXMLable curObj, String name, 
	...
	return new Failure();
      }else if(name.equals(RoutesData.NAME_TAG)){
	return new RoutesData();
      }
    }else if((curObj instanceof RoutesData)&&
	     name.equals(Route.NAME_TAG)){
      return new Route();
    }
    return null;
  }
