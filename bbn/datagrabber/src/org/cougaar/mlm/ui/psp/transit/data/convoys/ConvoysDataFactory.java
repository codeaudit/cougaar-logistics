 ...
 * @since 1/28/01
 **/
public class ConvoysDataFactory implements DeXMLableFactory{
  ...
  public DeXMLable beginSubObject(DeXMLable curObj, String name, 
	...
	return new Failure();
      }else if(name.equals(ConvoysData.NAME_TAG)){
	return new ConvoysData();
      }
    }else if((curObj instanceof ConvoysData)&&
	     name.equals(Convoy.NAME_TAG)){
      return new Convoy();
    }
    return null;
  }
