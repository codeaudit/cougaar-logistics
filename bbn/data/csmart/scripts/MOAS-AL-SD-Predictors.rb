...
Cougaar.new_experiment("SocA-MOAS-AL-SD-Predictors").run(1) {
...
#  wait_for "Command", "ok"
  ...
  do_action "Sleep", 1.minutes
  include "inventory.inc", "5Day_CommLoss"
  do_action "Sleep", 1.minutes
  ...
  #wait for all the messages to clear and plugins to reconcile
  #think quiescence detection could show completion before messages were sent?
  do_action "Sleep", 5.minutes
