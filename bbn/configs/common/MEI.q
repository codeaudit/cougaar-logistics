...
AmmunitionArmyNSN=select MEI_NSN, DODIC, UPPER(OPTEMPO), TONS_PER_DAY from oplog_ammorate where MEI_NSN = :nsn and ECHELON = :echelon order by TONS_PER_DAY desc
