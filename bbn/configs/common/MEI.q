...
AmmunitionArmyNSN=select MEI_NSN, DODIC, UPPER(OPTEMPO), TONS_PER_DAY from oplog_ammorate where MEI_NSN = :nsn and service = 'ARMY' and echelon = 'BATTALION' order by TONS_PER_DAY desc
