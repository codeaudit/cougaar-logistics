...
/** simple piece of data returned from the CPUConditionServlet */
public class CPUSettingData implements XMLable, DeXMLable, Serializable{

  //Variables:
  ////////////

  public static final String NAME_TAG = "CPUSettingData";
  boolean wasSet = false;

  //Constructors:
  ///////////////

  public CPUSettingData(boolean val) { setWasSet(val);}
