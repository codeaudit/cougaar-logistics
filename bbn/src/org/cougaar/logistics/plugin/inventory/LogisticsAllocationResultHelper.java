 ...
 **/
public class LogisticsAllocationResultHelper {
  public class Phase {
  ...
  public LogisticsAllocationResultHelper(Task task, PlanElement pe) {
...
// 	    System.err.println("   " + phase[q]);
  ...
  /**
   * Set a late value or partial value over a period of time
   **/
