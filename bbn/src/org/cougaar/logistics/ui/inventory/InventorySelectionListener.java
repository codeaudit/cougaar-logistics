 ...
 * <pre>
 * 
 * The InventorySelectionListener is the interface that allows for the
 * broadcast of the InventorySelectionEvent from the InventorySelectionPanel
 * to other parts of the ui.
 * 
 * 
 * @see InventorySelectionPanel
